(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2019/07/31', function(event) {
    ...
    ==========================================================================*/
        $(window).on('load', function() {
            ...
            var groom = decodeURI(keys.groom);
            var bride = decodeURI(keys.bride);
            ...
            var groomChar = groom.charAt(0);
            var brideChar = bride.charAt(0);
            

            $('.groom-name').text(groom);
            $('.bride-name').text(bride);
            $('.groom-char').text(groomChar);
            $('.bride-char').text(brideChar);
